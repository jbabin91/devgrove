...
<Callout type="danger">
  Make sure to use the registry for dev-grove-ui. You do this by ensuring you
  have the `REGISTRY_URL=https://ui.dev-grove.com/r` environment variable set
...
```bash
REGISTRY_URL=https://ui.dev-grove.com/r npx shadcn@latest init
```
...
- Using the components URL. (Note you will need to specify the style, e.g `https://ui.dev-grove.com/new-york/button`)
...
# this method you must specify the style, e.g new-york would be https://ui.dev-grove.com/new-york/button
```
