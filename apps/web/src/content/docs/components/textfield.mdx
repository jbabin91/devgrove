...
component: true
links:
  ariaDoc: https://react-spectrum.adobe.com/react-aria/TextField.html
---
...
```bash
REGISTRY_URL=https://ui.dev-grove.com/r npx shadcn@latest add textfield
```
...
The installed file includes a reusable wrapper `GroveTextField`. This wrapper serves as an excellent starting point for use throughout your codebase.

<ComponentPreview name="textfield-reusable" />

The `GroveTextField` component extends the props of React Aria TextField and adds:
