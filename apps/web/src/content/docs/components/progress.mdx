...
component: true
links:
  ariaDoc: https://react-spectrum.adobe.com/react-aria/ProgressBar.html
---
...
```bash
REGISTRY_URL=https://ui.dev-grove.com/r npx shadcn@latest add progress
```
...
The installed file includes a reusable wrapper `GroveProgressBar`. This wrapper serves as an excellent starting point for use throughout your codebase.

<ComponentPreview name="progressbar-reusable" />

The `GroveProgressBar` component extends the props of React Aria Progress and adds:
