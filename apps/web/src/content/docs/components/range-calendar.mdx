...
component: true
links:
  ariaDoc: https://react-spectrum.adobe.com/react-aria/RangeCalendar.html
---
...
```bash
REGISTRY_URL=https://ui.dev-grove.com/r npx shadcn@latest add calendar
```
...
The installed file includes a reusable wrapper `GroveRangeCalendar`. This wrapper serves as an excellent starting point for use throughout your codebase.

<ComponentPreview name="rangecalendar-reusable" />

The `GroveRangeCalendar` component extends the props of React Aria RangeCalendar and adds:
