...
component: true
links:
  ariaDoc: https://react-spectrum.adobe.com/react-aria/CheckboxGroup.html
---
...
```bash
REGISTRY_URL=https://ui.dev-grove.com/r npx shadcn@latest add checkbox
```
...
The installed file includes a reusable wrapper `GroveCheckboxGroup`. This wrapper serves as an excellent starting point for use throughout your codebase.

<ComponentPreview name="checkbox-group-reusable" />

The `GroveCheckboxGroup` component extends the props of React Aria CheckboxGroup and adds:
