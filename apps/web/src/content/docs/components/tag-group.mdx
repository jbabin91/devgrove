...
component: true
links:
  ariaDoc: https://react-spectrum.adobe.com/react-aria/TagGroup.html
---
...
```bash
REGISTRY_URL=https://ui.dev-grove.com/r npx shadcn@latest add tag-group
```
...
The installed file includes a reusable wrapper `GroveTagGroup`. This wrapper serves as an excellent starting point for use throughout your codebase.

<ComponentPreview name="tag-group-reusable" />

The `GroveTagGroup` component extends the props of React Aria TagGroup and TagList, and adds:
