...
component: true
links:
  ariaDoc: https://react-spectrum.adobe.com/react-aria/DatePicker.html
---
...
The installed file includes a reusable wrapper `GroveDatePicker`. This wrapper serves as an excellent starting point for use throughout your codebase.

<ComponentPreview name="datepicker-reusable" />

The `GroveDatePicker` component extends the props of React Aria DatePicker and adds:
