...
component: true
links:
  ariaDoc: https://react-spectrum.adobe.com/react-aria/Select.html
---
...
```bash
REGISTRY_URL=https://ui.dev-grove.com/r npx shadcn@latest add select
```
...
The installed file includes a reusable wrapper `GroveSelect`. This wrapper serves as an excellent starting point for use throughout your codebase.

<ComponentPreview name="select-reusable" />

The `GroveSelect` component extends the props of React Aria Select and adds:
