...
component: true
links:
  ariaDoc: https://react-spectrum.adobe.com/react-aria/ComboBox.html
---
...
```bash
REGISTRY_URL=https://ui.dev-grove.com/r npx shadcn@latest add combobox
```
...
The installed file includes a reusable wrapper `GroveComboBox`. This wrapper serves as an excellent starting point for use throughout your codebase.

<ComponentPreview name="combobox-reusable" />

The `GroveComboBox` component extends the props of React Aria ComboBox and adds:
