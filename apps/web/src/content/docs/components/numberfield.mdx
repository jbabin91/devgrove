...
component: true
links:
  ariaDoc: https://react-spectrum.adobe.com/react-aria/NumberField.html
---
...
```bash
REGISTRY_URL=https://ui.dev-grove.com/r npx shadcn@latest add numberfield
```
...
The installed file includes a reusable wrapper `GroveNumberField`. This wrapper serves as an excellent starting point for use throughout your codebase.

<ComponentPreview name="numberfield-reusable" />

The `GroveNumberField` component extends the props of React Aria NumberField and adds:
