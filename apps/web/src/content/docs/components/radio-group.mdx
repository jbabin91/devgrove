...
component: true
links:
  ariaDoc: https://react-spectrum.adobe.com/react-aria/RadioGroup.html
---
...
```bash
REGISTRY_URL=https://ui.dev-grove.com/r npx shadcn@latest add radio-group
```
...
The installed file includes a reusable wrapper `GroveRadioGroup`. This wrapper serves as an excellent starting point for use throughout your codebase.

<ComponentPreview name="radiogroup-reusable" />

The `GroveRadioGroup` component extends the props of React Aria RadioGroup and adds:
