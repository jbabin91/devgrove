...
component: true
links:
  ariaDoc: https://react-spectrum.adobe.com/react-aria/TimeField.html
---
...
```bash
REGISTRY_URL=https://ui.dev-grove.com/r npx shadcn@latest add datefield
```
...
The installed file includes a reusable wrapper `GroveTimeField`. This wrapper serves as an excellent starting point for use throughout your codebase.

<ComponentPreview name="timefield-reusable" />

The `GroveTimeField` component extends the props of React Aria TimeField and adds:
