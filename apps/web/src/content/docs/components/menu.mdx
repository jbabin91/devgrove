...
component: true
links:
  ariaDoc: https://react-spectrum.adobe.com/react-aria/Menu.html
---
...
```bash
REGISTRY_URL=https://ui.dev-grove.com/r npx shadcn@latest add menu
```
...
The installed file includes a reusable wrapper `GroveMenu`. This wrapper serves as an excellent starting point for use throughout your codebase.

<ComponentPreview name="menu-reusable" />

The `GroveMenu` component extends the props of React Aria Menu and MenuTrigger, and includes button styling props:
