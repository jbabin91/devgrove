 ...
 *
 * @component
 * @param {Omit<DateInputProps, 'children'>} props - The props for the DateInput component.
 * @param {string} [props.className] - The class name for the component.
 ...
 * @param {string} [props.errorMessage] - The error message for the GroveDateField component.
 ...
 * @property {string} [description] - The description for the component.
 * @property {string | ((validation: AriaValidationResult) => string)} [errorMessage] - The error message for the component.
 ...
 * @param {string} [props.errorMessage] - The error message for the GroveTimeField component.
