 ...
 *
 * @component
 * @param {AriaGroupProps} props - The props for the search field group.
 * @param {string} [props.className] - The class name for the search field group.
 ...
 *
 * @component
 * @param {AriaButtonProps} props - The props for the button.
 ...
 * @property {AriaSearchFieldProps} [AriaSearchFieldProps] - Additional props for the AriaSearchField component.
 */
 ...
 * @param {string} [props.errorMessage] - The error message for the search field.
 * @param {string} [props.className] - The class name for the search field.
