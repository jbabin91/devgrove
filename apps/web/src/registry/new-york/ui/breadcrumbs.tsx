 ...
 * @param {AriaBreadcrumbsProps<T>} props - The props for the breadcrumbs component.
 * @param {string} [props.className] - The class name for the breadcrumbs component.
...
/**
 * Renders a breadcrumb link component.
 *
 * @component
 ...
 * @param {React.ReactNode} [props.children] - The content to be rendered inside the separator.
 ...
 * @component
 * @param {React.ComponentProps<'span'>} props - The component props.
 * @param {string} [props.className] - The CSS class name for the ellipsis.
