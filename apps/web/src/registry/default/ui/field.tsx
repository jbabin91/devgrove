 ...
 * @param {string} props.className - The class name for the label.
  ...
  variants: {
    variant: {
      default: [
        ...
        /* Focus Within */
        'data-[focus-within]:ring-ring data-[focus-within]:outline-none data-[focus-within]:ring-2 data-[focus-within]:ring-offset-2',
        /* Disabled */
 ...
 *
 * @param className - The CSS class name for the field group.
 * @param variant - The variant of the field group.
 * @param props - Additional props for the field group.
